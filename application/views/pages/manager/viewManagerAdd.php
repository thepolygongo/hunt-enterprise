        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Create a manager</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                            <input type="account_type" name="account_type" class="form-control input100" value="pro_manager" readonly>
                            </div>
                        </div>
                    </div>
                    <!-- /.box-body -->
...
<script>
    function onSend() {
        ...
        $.post('<?php echo base_url() ?>manager/createSpecial', {
            username: username,
            email: email,
            ...
            if (obj.result == 'ok') {
                location.href = '<?php echo base_url() ?>/manager/viewManagerList';
            } else {
                alert(obj.message);
            }
        });
